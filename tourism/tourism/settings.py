...
# LOGIN_URL = '/login/'  # Redirect here if the user tries to access a protected page without being logged in
# LOGIN_REDIRECT_URL = '/add-package/'  # Redirect here after a successful login
LOGOUT_REDIRECT_URL = '/home/'  # Redirect here after logging out
